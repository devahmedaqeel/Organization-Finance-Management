...
const deficitTxs: Transaction[] = [
  { id: "t1", type: "income", category: "Grant", amount: 10000, date: "2026-08-05", department: "Admin" },
  { id: "t2", type: "expense", category: "Rent", amount: 25000, date: "2026-08-10", department: "Admin" },
];
...
const growthTxs: Transaction[] = [
  { id: "p1", type: "income", category: "Sales", amount: 50000, date: "2026-07-15", department: "Sales" },
  { id: "c1", type: "income", category: "Sales", amount: 80000, date: "2026-08-15", department: "Sales" },
];
...
const budgets: Budget[] = [
  { id: "b-mkt", category: "Marketing", department: "Growth", allocated: 100000, spent: 88000 },
  { id: "b-ops", category: "Operations", department: "Operations", allocated: 50000, spent: 65000 },
];
const budgetTxs: Transaction[] = [
  { id: "tx-m1", type: "expense", category: "Marketing", amount: 88000, date: "2026-08-10", department: "Growth" },
  { id: "tx-o1", type: "expense", category: "Operations", amount: 65000, date: "2026-08-12", department: "Operations" },
];
...
const anomalyTxs: Transaction[] = [
  { id: "a1", type: "expense", category: "Office Supplies", amount: 2000, date: "2026-08-01", department: "Admin" },
  { id: "a2", type: "expense", category: "Office Supplies", amount: 2500, date: "2026-08-03", department: "Admin" },
  { id: "a3", type: "expense", category: "Office Supplies", amount: 1800, date: "2026-08-07", department: "Admin" },
  { id: "a4", type: "expense", category: "Office Supplies", amount: 2200, date: "2026-08-10", department: "Admin" },
  { id: "a5", type: "expense", category: "Office Supplies", amount: 45000, date: "2026-08-15", department: "Admin" }, // Outlier!
];
...
const duplicateTxs: Transaction[] = [
  { id: "d1", type: "expense", category: "Software Subscription", amount: 12000, date: "2026-08-10", department: "Engineering" },
  { id: "d2", type: "expense", category: "Software Subscription", amount: 12000, date: "2026-08-11", department: "Engineering" },
  { id: "d3", type: "expense", category: "Travel", amount: 5000, date: "2026-08-15", department: "Sales" },
  { id: "d4", type: "expense", category: "Meals", amount: 3000, date: "2026-08-18", department: "Sales" },
];
