...
export function NetBalanceBreakdownModal({
  ...
  const [expandedFormula, setExpandedFormula] = useState<string | null>("cashflow_net");
  ...
  const totalBudgetSpent = useMemo(() => calculateBudgetUsed(transactions, budgets, undefined, departments), [transactions, budgets, departments]);
                ...
                <View style={[styles.heroCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                  ...
                  <View style={styles.heroTopRow}>
                    <View style={{ flex: 1, marginRight: 8 }}>
                      ...
                      <Text style={[styles.heroValue, { color: isCurrentModalSurplus ? colors.income : colors.expense }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.65}>
                      ...
                      <Text style={{ color: colors.mutedForeground, fontSize: 11, marginTop: 2, fontFamily: "Inter_500Medium" }}>
                        {modalBalanceMode === "budget" && totalBudgeted > 0
                          ...
                          : modalBalanceMode === "surplus" && totalBudgeted > 0
                          ? `Total Income: ${settings.currency} ${fmt(totalIncome)} · Allocated Budget: ${settings.currency} ${fmt(totalBudgeted)}`
                    ...
                    <View style={[styles.statusPill, { backgroundColor: (isCurrentModalSurplus ? colors.income : colors.expense) + "18", borderColor: (isCurrentModalSurplus ? colors.income : colors.expense) + "44" }]}>
                      ...
                      <Text style={[styles.statusPillText, { color: isCurrentModalSurplus ? colors.income : colors.expense }]}>
                        {modalBalanceMode === "budget" && totalBudgeted > 0
                          ...
                          : modalBalanceMode === "surplus" && totalBudgeted > 0
                          ? (unallocatedFunds > 0 ? "UNALLOCATED FUNDS AVAILABLE" : "FUNDS FULLY ALLOCATED")
                  ...
                  <View style={styles.metricsStrip}>
                    <View style={[styles.metricBlock, { backgroundColor: colors.background, borderColor: colors.border }]}>
                      <Text style={[styles.metricBlockLabel, { color: colors.mutedForeground }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.7}>
                        {modalBalanceMode === "budget" && totalBudgeted > 0
                          ? "Budget Used"
                          : modalBalanceMode === "surplus" && totalBudgeted > 0
                          ? "Unallocated %"
                      ...
                      <Text style={[styles.metricBlockSub, { color: colors.mutedForeground }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.7}>
                        {modalBalanceMode === "budget" && totalBudgeted > 0
                    ...
                    <View style={[styles.metricBlock, { backgroundColor: colors.background, borderColor: colors.border }]}>
                      ...
                      <Text style={[styles.metricBlockVal, { color: colors.primary }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.65}>
                        {modalBalanceMode === "budget" && totalBudgeted > 0
                          ...
                          styles.metricBlockVal,
                          {
                            color:
                              modalBalanceMode === "budget" && totalBudgeted > 0
                                ...
                                : modalBalanceMode === "surplus" && totalBudgeted > 0
                                ? (netBudgetRemaining >= 0 ? colors.income : colors.expense)
                    ...
                    <View style={styles.progressLabelRow}>
                      ...
                      <Text style={{ fontSize: 11, color: colors.expense, fontFamily: "Inter_700Bold" }}>
                        {modalBalanceMode === "budget" && totalBudgeted > 0
                          ...
                          : modalBalanceMode === "surplus" && totalBudgeted > 0
                          ? `Allocated Budget: ${settings.currency} ${fmt(totalBudgeted)}`
                  ...
                  <View style={[styles.formulaCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                    ...
                    >
                      <View style={{ flexDirection: "row", alignItems: "center", gap: 8, flex: 1 }}>
                        ...
                        <View style={{ flex: 1 }}>
                          <Text style={[styles.formulaTitle, { color: colors.foreground }]}>Unallocated Available Funds</Text>
                          <Text style={[styles.formulaSub, { color: colors.mutedForeground }]}>Formula: Total Income − Allocated Department Budget</Text>
                        </View>
                      </View>
                    ...
                    {expandedFormula === "pool_surplus" && (
                      <View style={[styles.formulaBody, { borderTopColor: colors.border }]}>
                        ...
                        <View style={[styles.formulaResultBox, { backgroundColor: colors.income + "15", borderColor: colors.income + "33" }]}>
                          <Text style={[styles.formulaResultLabel, { color: colors.mutedForeground }]}>Live Calculation Result:</Text>
                          <Text style={[styles.formulaResultVal, { color: colors.income }]}>
                            {settings.currency} {fmt(unallocatedFunds)} ({unallocatedPct.toFixed(1)}% Available Reserve)
                          </Text>
                        </View>
                        <Text style={[styles.formulaExplanation, { color: colors.mutedForeground }]}>
                          • Income is the source of available funds. Department budgets are allocated out of income.
                          {"\n"}• Current status indicates {settings.currency} {fmt(unallocatedFunds)} ({unallocatedPct.toFixed(1)}%) remains unallocated and liquid.
                        </Text>
                      </View>
                    )}
                  </View>
                    ...
                    <View key={m.monthKey} style={[styles.momDetailedCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                      ...
                      <View style={styles.momBarGrid}>
                        <View style={[styles.momBarBox, { backgroundColor: colors.background, borderColor: colors.border }]}>
                          <Text style={[styles.momBarBoxLabel, { color: colors.mutedForeground }]} numberOfLines={2}>Inflows</Text>
                          <Text style={[styles.momBarBoxVal, { color: colors.income }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.7}>
                            +{settings.currency} {fmtShort(m.income)}
                          </Text>
                        </View>
                        <View style={[styles.momBarBox, { backgroundColor: colors.background, borderColor: colors.border }]}>
                          <Text style={[styles.momBarBoxLabel, { color: colors.mutedForeground }]} numberOfLines={2}>Outflows</Text>
                          <Text style={[styles.momBarBoxVal, { color: colors.expense }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.7}>
                            -{settings.currency} {fmtShort(m.expense)}
                          </Text>
                        </View>
                        <View style={[styles.momBarBox, { backgroundColor: colors.background, borderColor: colors.border }]}>
                          <Text style={[styles.momBarBoxLabel, { color: colors.mutedForeground }]} numberOfLines={2}>MoM Shift</Text>
                          <Text style={[styles.momBarBoxVal, { color: m.isPositiveShift ? colors.income : colors.expense }]} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.7}>
